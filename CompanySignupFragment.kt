...
class CompanySignupFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        register!!.setOnClickListener(View.OnClickListener {
            if (name!!.getText().toString().equals("", ignoreCase = true)
                ...
                url += email!!.getText().toString() + "/" + password!!.getText() + "/" + name!!.getText()
    ...
    companion object {
        fun newInstance(): CompanySignupFragment {
            return CompanySignupFragment()
        }
    }
}