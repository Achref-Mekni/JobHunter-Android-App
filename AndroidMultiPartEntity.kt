...
class AndroidMultiPartEntity : MultipartEntity {
    ...
    constructor(mode: HttpMultipartMode?,
                listener: ProgressListener) : super(mode) {
        this.listener = listener
    }

    constructor(mode: HttpMultipartMode?, boundary: String?,
                charset: Charset?, listener: ProgressListener) : super(mode, boundary, charset) {
        this.listener = listener
    }
    ...
    class CountingOutputStream(out: OutputStream?,
                               private val listener: ProgressListener) : FilterOutputStream(out) {
